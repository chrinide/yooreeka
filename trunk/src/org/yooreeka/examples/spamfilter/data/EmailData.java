...
public class EmailData {
    ...
    public static String[][] TRAINING_DATA = new String[][] {
        {YooreekaConfigurator.getHome()+"/data/ch02/biz-02.html", "A@sengerhost", "1@host"},
        {YooreekaConfigurator.getHome()+"/data/ch02/biz-03.html", "B@sengerhost", "2@host"},
        {YooreekaConfigurator.getHome()+"/data/ch02/biz-04.html", "C@sengerhost", "3@host"},
        {YooreekaConfigurator.getHome()+"/data/ch02/biz-05.html", "D@sengerhost", "4@host"},
        {YooreekaConfigurator.getHome()+"/data/ch02/biz-06.html", "E@sengerhost", "5@host"},
        {YooreekaConfigurator.getHome()+"/data/ch02/biz-07.html", "F@sengerhost", "6@host"},
        {YooreekaConfigurator.getHome()+"/data/ch02/sport-02.html", "G@sengerhost", "7@host"},
        {YooreekaConfigurator.getHome()+"/data/ch02/sport-03.html", "H@sengerhost", "8@host"},
        {YooreekaConfigurator.getHome()+"/data/ch02/usa-02.html", "I@sengerhost", "9@host"},
        {YooreekaConfigurator.getHome()+"/data/ch02/usa-03.html", "J@sengerhost", "10@host"},
        {YooreekaConfigurator.getHome()+"/data/ch02/usa-04.html", "K@sengerhost", "11@host"},
        {YooreekaConfigurator.getHome()+"/data/ch02/world-02.html", "L@sengerhost", "12@host"},
        {YooreekaConfigurator.getHome()+"/data/ch02/world-03.html", "M@sengerhost", "13@host"},
        {YooreekaConfigurator.getHome()+"/data/ch02/world-04.html", "N@sengerhost", "14@host"},
        {YooreekaConfigurator.getHome()+"/data/ch02/world-05.html", "O@sengerhost", "15@host"},
        {YooreekaConfigurator.getHome()+"/data/ch02/spam-biz-02.html", "P@sengerhost", "16@host"},
        {YooreekaConfigurator.getHome()+"/data/ch02/spam-biz-03.html", "Q@sengerhost", "17@host"}
    };

    public static String[][] TEST_DATA = new String[][] {
        {YooreekaConfigurator.getHome()+"/data/ch02/biz-01.html", "aa@senderhost", "100@host"},
        {YooreekaConfigurator.getHome()+"/data/ch02/sport-01.html", "bb@senderhost","101@host"},
        {YooreekaConfigurator.getHome()+"/data/ch02/usa-01.html", "cc@senderhost", "102@host"},
        {YooreekaConfigurator.getHome()+"/data/ch02/world-01.html", "dd@senderhost", "103@host"},
        {YooreekaConfigurator.getHome()+"/data/ch02/spam-biz-01.html", "friend@senderhost", "104@host"}
    };
