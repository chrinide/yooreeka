...
public class TenUsersSample {
    ...
    public static String TXN_DESC_FILENAME = 
    	YooreekaConfigurator.getHome()+"/data/ch05/fraud/descriptions.txt";

    /*
     * File with descriptions to be used for fraud transactions.
     */
    public static String FRAUD_TXN_DESC_FILENAME = 
    	YooreekaConfigurator.getHome()+"/data/ch05/fraud/fraud-descriptions.txt";    

    /*
     * Generated transactions will be saved into this file.
     */
    public static String TRAINING_TXN_FILENAME = 
    	YooreekaConfigurator.getHome()+"/data/ch05/fraud/generated-training-txns.txt";
    
    public static String TEST_TXN_FILENAME = 
    	YooreekaConfigurator.getHome()+"/data/ch05/fraud/generated-test-txns.txt";
    ...
    public static void printTxns(String txnFilename) {
        ...
        List<Transaction> allTxns = FraudDataUtils.loadTransactions(txnFilename);
    ...
    public static TransactionSetProfile[] createUsersForTraining() {
        ...
        String[] txnDescriptions = FraudDataUtils.loadTxnDescriptions(TXN_DESC_FILENAME);
        String[] fraudTxnDescriptions = 
            FraudDataUtils.loadTxnDescriptions(FRAUD_TXN_DESC_FILENAME);
