...
import org.yooreeka.examples.classification.fraud.credit.data.users.BadUserType;
import org.yooreeka.examples.classification.fraud.credit.data.users.DangerousUserType;
import org.yooreeka.examples.classification.fraud.credit.data.users.ExcellentUserType;
import org.yooreeka.examples.classification.fraud.credit.data.users.GoodUserType;
import org.yooreeka.examples.classification.fraud.credit.data.users.User;
import org.yooreeka.examples.classification.fraud.credit.data.users.UserType;
import org.yooreeka.examples.classification.fraud.credit.data.users.VeryGoodUserType;
import org.yooreeka.examples.classification.fraud.credit.util.DataGenerator;
...
public class UseCaseData {
    ...
    public static String TRAINING_USERS_FILENAME = 
    	YooreekaConfigurator.getHome()+"/data/ch06/generated-training-users.txt";
    
    public static String TEST_USERS_FILENAME = 
    		YooreekaConfigurator.getHome()+"/data/ch06/generated-test-users.txt";
	...
	public void create(boolean overwrite) {
		if (overwrite) {
			TRAINING_USERS_FILENAME = YooreekaConfigurator.getHome()+"/data/ch06/training-users.txt";
			TEST_USERS_FILENAME = YooreekaConfigurator.getHome()+"/data/ch06/test-users.txt";
		}		
		create();
	}
